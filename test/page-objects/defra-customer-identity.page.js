...
class DefraCustomerIdentityPage extends Page {
  get mainHeading() {
    return $('h1')
  }
  ...
  open() {
    return super.open('/architecture-and-software-development/defra-customer-identity')
  }
...
export default new DefraCustomerIdentityPage()
